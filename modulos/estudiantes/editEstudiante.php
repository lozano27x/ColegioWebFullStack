<?php 
    ...
    $result = $conexion->editEstudiante($id);
        ...
        $estud_id = $estud_identificacion = $estud_nombres = $estud_apellidos = $estud_email = $estud_telefono = $estud_pais = $estud_ciudad = $estud_grado ="";
                    ...
                    <div class="card-body">
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pais" name="pais" value="<?= $estud_pais ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="ciudad">Ciudad</label>
                                <input type="text" class="form-control" id="ciudad" name="ciudad" value="<?= $estud_ciudad ?>" required>
                            </div>
